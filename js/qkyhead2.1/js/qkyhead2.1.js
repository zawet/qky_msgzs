...
/*********一，数据初始化**************/		
	var qkyhead_data={/*导航数据*/
	    htmlsrc:"js/qkyhead2.1/js/qkyhead2.1.html",//头部模板获取异步地址
		logosrc:"js/qkyhead2.1/images/nav_logo/qky-logo.png",//logo来源路径
		pjname:"名师工作室",//应用名
		csssrc:"js/qkyhead2.1/css/qkyhead.css",
		theme:"white_blue",//主题 目前有白蓝（white_blue）,黑蓝（black_blue）
		themesrc:"js/qkyhead2.1/css/theme/",//主题路径(引用的插件的文件地址为起始地址)
		navli_j:[
		...
		tea_info:{"name":"请登录","isphoto":false,"photo":"images/tx01.png"},//个人信息
		otherli:[],//设置菜单

		isnews:false,//是否显示信息铃铛
		newsimgsrc:"js/qkyhead2.1/images/appicon/",//应用图标的来源路径
